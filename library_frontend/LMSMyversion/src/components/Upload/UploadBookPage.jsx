...
//                 {pdfSelected && !loadingPDF && files?.pdf && (
//                   <div className="flex flex-col items-center gap-2 text-gray-700">
//                     <span className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-rose-100">
//                       <FileText className="text-rose-600" size={28} />
//                     </span>
...
// import { useState } from "react";
// import api from "../../config/api"; // shared axios instance
// import {
//   Image as ImageIcon,
//   FileText,
//   FileAudio,
...
//           <div className="relative z-10 w-[92%] sm:w-[86%] md:w-[90%] max-w-md rounded-2xl bg-white shadow-xl px-6 py-8 text-center transition-all duration-300 ease-out animate-[pop_0.28s_ease-out]">
//             <button className="absolute right-3 top-3 p-1 rounded-full hover:bg-gray-100" onClick={() => setShowSuccess(false)}>
//               <X size={18} />
//             </button>
...
//               Book Uploaded Successfully <PartyPopper className="text-amber-500 animate-bounce" size={20} />
//             </h3>
