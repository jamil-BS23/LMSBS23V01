...
const BookDetails = () => {
  ...
  return (
    <div style={{ maxWidth: "700px", margin: "40px auto", padding: "20px", boxShadow: "0 2px 10px rgba(0,0,0,0.2)", borderRadius: "10px" }}>
      <h2 style={{ marginBottom: "10px" }}>{book.title}</h2>
      <h4 style={{ margin: "5px 0", color: "#555" }}>Author: {book.author}</h4>
      <p style={{ margin: "5px 0", color: "#777" }}>Category: {book.category}</p>
      <p style={{ margin: "15px 0", lineHeight: "1.6" }}>{book.description}</p>
      <p style={{ fontWeight: "bold", color: "#333" }}>Rating: {book.rating} / 5</p>
    </div>
  );
};
